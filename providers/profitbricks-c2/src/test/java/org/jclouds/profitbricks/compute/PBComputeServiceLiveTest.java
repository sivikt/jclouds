...
/**
 * Live test for ProfitBricks API
 *
 * @author Serj Sintsov
 */
@Test(groups = "live", singleThreaded = true, testName = "PBComputeServiceLiveTest")
public class PBComputeServiceLiveTest extends BaseComputeServiceLiveTest {

   public PBComputeServiceLiveTest() {
